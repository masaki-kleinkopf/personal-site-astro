export const projectData = [
  {
    ...
    subTitle: "Munchkin",
    description:
      "<p>Frontend Developer on the Munchkin team which built a new Munchkin redesign from the ground-up. Work included building reusable form UI library components, a new footer with animations, and a new, modular PDP with components such as a masonry grid and Mux powered video player with custom custom control bar.</p>",
    ...
    photos: [
      ...
      { src: "/images/mck-2.png", caption: "Video player with custom controls" },
  ...
  },
  {
    ...
    subTitle: "Bean.LA",
    description:
      '<p>Built new features for <a href="https://givehanx.com" target="_blank">Hanx</a>, a coffee brand by Tom Hanks. Work included creating a new product model for coffee products, new quantity based subscriptions, a gift card recipient form, and new UI such as a meganav and featured upsell products carousel.</p>',
  ...
  },
  {
    ...
    photos: [
      {
        src: "/images/s94-1.webp",
        caption: "Home page shop carousel, made possible with Shopify/Sanity integration.",
      },
  ...
  },
  {
    ...
    subTitle: "Bean.LA",
    description:
      '<p>Developer for <a href="https://dublab.com" target="_blank">Dublab</a>, a continuing Bean client. Migrated Dublab\'s calendar system from WordPress to Google Calendar API, which included creating serverless functions to utilize new data and building a new frontend for the schedule page.</p>',
