export const projectData = [
  ...
  techStack: 'Nuxt3/Vue/TypeScript, Sanity CMS, Node, SCSS',
   photos: [{
    src:'src/images/ln-6.webp',
    caption: 'Home page'
  },
  {src:'src/images/ln-10.webp', caption: 'Lightbox with shareable url'},
  {src:'src/images/ln-5.webp', caption: 'Venue page'},
  {src:'src/images/ln-4.webp', caption: 'Venue page with social media carousel'},
  {src:'src/images/ln-3.webp', caption: 'Gallery grid'},
  {src:'src/images/ln-7.webp', caption: 'Mobile lightbox'},
  {src:'src/images/ln-8.webp', caption: 'Mobile tech pack download'},
  ...
  techStack: 'Shopify Liquid, Vue, SCSS',
   photos: [{
    src:'src/images/hanx-1.webp',
    caption: 'meganav'
  },
  {src:'src/images/hanx-5.webp', caption: 'gift card with recipient form'},
  {src:'src/images/hanx-4.webp', caption: 'PDP'},
  {src:'src/images/hanx-2.webp', caption: 'mobile cart'},
  {src:'src/images/hanx-3.webp', caption: 'new products by flavor'},
  {src:'src/images/hanx-6.webp', caption: 'mobile PDP subscription selectors'},
]
  },
  {title:"Salon94",
  subTitle: 'Bean.LA',
  ...
  photos:[
    {src:'src/images/s94-1.webp', caption: 'Home page shop carousel, made possible with Shopify/Sanity integration.'},
    {src:'src/images/s94-6.webp', caption: 'New home page'},
    {src:'src/images/s94-3.webp', caption: 'Shop PDP'},
    {src:'src/images/s94-2.webp', caption: 'Shop page'},
    {src:'src/images/s94-5.webp', caption: 'Home page on view grid'},
    {src:'src/images/s94-4.webp', caption: 'Cart'},
  ]
},
  {title:'Dublab',
  subTitle: 'Bean.LA',
  ...
  photos:[
    {src:'src/images/dublab-1.webp', caption: 'Schedule page'},
    {src:'src/images/dublab-3.webp', caption: 'Mobile schedule page'},
    {src:'src/images/dublab-2.webp', caption: 'Active date functionality'},
    {src:'src/images/dublab-4.webp', caption: 'Home page with marquee'},
  ]
},
...
techStack: 'React, CSS',
photos:[
  {src:'src/images/cfe-5.webp', caption: 'CFE intro page'},
  {src:'src/images/cfe-1.webp', caption: 'CFE game board'},
  {src:'src/images/cfe-2.webp', caption: 'Store'},
  {src:'src/images/cfe-3.webp', caption: 'Nutrition Status Card'},
  {src:'src/images/cfe-4.webp', caption: 'Food item card'},
]
},
]